...
var posList,
    ...
    chartBarHorizontalColors =
        (chartBarLabelRotationColors &&
            ...
            (app.config = {
                ...
                distance: 15,
                onChange: function () {
                    var t = { rotate: app.config.rotate, align: app.config.align, verticalAlign: app.config.verticalAlign, position: app.config.position, distance: app.config.distance };
        ...
        (chartBarStackedColors &&
            ...
            (option = {
                ...
                series: [
                    ...
                    { name: "Video Ads", type: "bar", stack: "total", label: { show: !0 }, emphasis: { focus: "series" }, data: [150, 212, 201, 154, 190, 330, 410] },
                ...
                series: [
                    {
                        ...
                        data: [
                            ...
                            { value: 735, name: "Predial" },
                            { value: 580, name: "Arbitrios" },
                            { value: 484, name: "Multas Tributarias" },
    ...
    chartFunnelColors =
        (chartSankeyColors &&
            ...
            myChart.setOption(option),
        getChartColorsArray("chart-funnel")),
    chartGaugeColors =
        (chartParallelColors &&
